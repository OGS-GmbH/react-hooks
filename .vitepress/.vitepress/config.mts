...
export default defineConfig({
  title: "react-hooks",
  description: "Providing reusable, composable abstractions for state management, side-effect control, and lifecycle orchestration in modern React applications.",
  themeConfig: {
    ...
    nav: [
      ...
      { text: packageJson.version, items: [
        { text: "Repository", link: "https://github.com/OGS-GmbH/react-hooks" },
        { text: "Changelog", link: "https://github.com/OGS-GmbH/react-hooks/blob/main/CHANGELOG.md" },
  ...
  outDir: "../dist/docs",
  titleTemplate: ":title - OGS react-hooks",
  cleanUrls: true,
  appearance: true,
  markdown: {
